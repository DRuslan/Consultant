...
const originalModals = {
    form1: {
        ...
        image: "https://s3-us-east-2.amazonaws.com/maryville/wp-content/uploads/2021/12/07093036/businessman-conference-room.jpg",
        formName: "modal-form1"
    },
    form2: {
        isActive: false,
        title: "Рассчитать стоимость проекта",
        subTitle: "и получите консультацию от наших специалистов",
        image: "/images/modals/1.jpg",
        formName: "modal-form2"
    },
    catalogMaterial: {
        isActive: false,
        title: "Проконсультироваться по материалу",
        subTitle: "и узнать о стоимости и наличии",
        image: "/images/CONTENT/03.png",
        formName: "modal-catalog"
    },
    feedback: {
        isActive: false,
        title: "Получить консультацию",
        subTitle: "Для уточнения деталей по продукту",
        image: "/images/CONTENT/05.png",
        formName: "feedback"
    },
    politic: {
        isActive: false,
        ...
        1. Общие положения и основные термины <br><br>
        ...
        Настоящая политика Оператора в отношении обработки персональных данных (далее – Политика) применяется ко всей информации, которую Оператор может получить о посетителях данного веб-сайта.<br>
        ...
        3.2.8. Исполнять иные обязанности, предусмотренные Законом о персональных данных.<br><br>
        ...
        5.4. Также на сайте происходит сбор и обработка обезличенных данных о посетителях с помощью сервисов интернет-статистики (Яндекс Метрика и других).<br>
        ...
        7.1.1. Информирование Пользователя посредством отправки электронных писем;<br>
        7.1.2.Заключение, исполнение и прекращение гражданско-правовых договоров;<br>
        7.1.3. Предоставление доступа Пользователю к сервисам, информации и/или материалам, содержащимся на веб-сайте.<br>
        7.2. Также Оператор имеет право направлять Пользователю уведомления о новых продуктах и услугах, специальных предложениях и различных событиях. Пользователь всегда может отказаться от получения информационных сообщений, направив Оператору письмо на Адрес электронной почты.<br>
        ...
        9.7. Осуществляется обработка персональных данных, подлежащих опубликованию или обязательному раскрытию в соответствии с федеральным законом (выложен на сайте о работе и подборе персонала ruscred.site).<br><br>
        ...
        13.1. Оператор и иные лица, получившие доступ к персональным данным, обязаны не раскрывать третьим лицам и не распространять персональные данные без согласия субъекта персональных данных, если иное не предусмотрено федеральным законом.<br><br>
...
const modals = reactive({ ...originalModals });

export const openModal = (key, newData = null) => {
    if (modals.hasOwnProperty(key)) {
        if (newData) {
            modals[key] = { ...originalModals[key], ...newData };
        } else {
            modals[key] = { ...originalModals[key] };
        }
...
export function getModalData(key) {
    return computed(() => modals.hasOwnProperty(key) ? modals[key] : originalModals[key]);
}
